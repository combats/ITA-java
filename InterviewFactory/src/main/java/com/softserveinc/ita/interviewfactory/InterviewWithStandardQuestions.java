 ...
 */
public class InterviewWithStandardQuestions extends Interview implements InterviewCreator {
...
//    }
    ...
    public InterviewWithStandardQuestions(String appointmentId) throws InvalidUserIDException, ApppoinmentNotFoundException {
        super(appointmentId, InterviewType.InterviewWithStandardQuestions);
        createInterview();
    }
