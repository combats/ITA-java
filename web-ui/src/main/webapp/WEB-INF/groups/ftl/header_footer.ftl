...
<head>
    ...
    <link rel="stylesheet" href="groups/css/icons/entypo/css/entypo.css" />
    <link rel="stylesheet" href="groups/css/flexslider.css" />
    <link rel="stylesheet" type="text/css" href="groups/css/style.css" />
</head>
